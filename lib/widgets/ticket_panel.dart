...
class _TicketPanelState extends State<TicketPanel> {
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                // Simple Debug Button to Add a Ticket
                IconButton(
            ...
            child: StreamBuilder<List<Map<String, dynamic>>>(
              ...
              builder: (context, snapshot) {
                ...
                return ListView.builder(
                  controller: widget.scrollController, // Important for SlidingUpPanel
  ...
  Widget _buildTicketCard(Map<String, dynamic> ticket) {
    ...
    final validUntil = ticket['valid_until'] != null 
        ? DateTime.parse(ticket['valid_until']) 
        : DateTime.now();
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: isExpired ? Colors.grey[200]! : Colors.blue[100]!,
        ),
      ),
      child: Padding(
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    isExpired ? "Expired" : "Valid until ${DateFormat('HH:mm').format(validUntil)}",
                    style: GoogleFonts.inter(
                      fontSize: 14,

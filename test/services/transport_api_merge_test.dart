  ...
  group('TransportApi.mergeResults', () {
    ...
    test('merges journeys with same time but different first line', () {
      ...
      final v6Journey = {
        'departure': time,
        'arrival': arr,
        'legs': [{'line': {'name': 'Tram 11'}}], // Different line
        'source': 'v6'
      };
